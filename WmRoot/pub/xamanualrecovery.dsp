                ...
                <td width="100%">
                    <table class="tableView">
                        ...
                        <tr>
                          ...
                          <!--  <td class="evenrowdata-l"><a href="javascript:document.listeners.submit();" onClick="return eraseTransaction(document.listeners, '%value -code xid%' );"><img src="icons/delete.png" border="no"></A></td> -->
                        </tr>
