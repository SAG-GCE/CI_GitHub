...
<head>
  ...
  <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    <li class="listitem"><a href="settings-cache-addedit.dsp?cacheManagerName=%value -urlencode cacheManagerName%&cacheName=%value -urlencode cacheName%&operation=edit">Return to&nbsp;%value cacheName%</a></li>
                </ul>
            </td>
        </tr>
        <tr>
