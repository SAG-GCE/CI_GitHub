            ...
            <table class="tableView" width="70%" id="filterTable">
                ...
                <tr>                
                        ...
                        <td width="80%" class="evenrow-l">
                            ...
                            %else%
                                <input name="icapEngineName" id="icapEngineName" MAXLENGTH="255"  value="%value icapEngineName%">
                            %endif%
                        </td>
                </tr>
                <tr>                
                        ...
                        <td width="80%" class="oddrow-l">
                            ...
                            %else%
                                <input name="icapHost" id="icapHost" MAXLENGTH="255" value="%value icapHost%">
                            %endif%
                        </td>
                </tr>
                <tr>                
                        ...
                        <td width="80%" class="evenrow-l">
                            ...
                            %else%
                                <input name="icapPort" id="icapPort"  value="%value icapPort%" MAXLENGTH="255">
                            %endif%
                        </td>
                </tr>
                <tr>                
                        ...
                        <td width="80%" class="oddrow-l">
                            ...
                            %else%
                                <input name="icapService" id="icapService" MAXLENGTH="255" value="%value icapService%">
                            %endif%
                        </td>
                </tr>
