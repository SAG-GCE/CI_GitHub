         ...
         %invoke wm.server.query:getThreadList%
                        ...
                        <script>writeTD('rowdata');</script>
                            ...
                            %else%
                                  %ifvar cancancel equals('true')%
                                    <A class="imagelink" href="server-threads-new.dsp?action=interrupt&threadID=%value threadid -urlencode%" onClick="return confirmAction('cancel', '%value name%');"><IMG src="images/yellow_check.png" border=0></A>
                                  %else%
                                    -
                                  %endif%   
                            %endif%</TD>
            <script>writeTD('rowdata');</script>
                %ifvar cankill equals('true')%
                  <A class="imagelink" href="server-threads-new.dsp?action=kill&threadID=%value threadid -urlencode%" onClick="return confirmAction('kill', '%value name%');"><IMG src="icons/delete.png" border=0></A>
                %else%
