        ...
        <TD colspan="2">
          <ul class="listitems">
            <li class="listitem"><a href="settings-wsendpoints.dsp">Return to Web Services</a></li>
              %ifvar action equals('view')%
                <li class="listitem"><a href="settings-wsendpoints-addedit.dsp?action=edit&alias=%value -urlencode alias%&type=%value type%&transportType=%value -urlencode transportType%">Edit Web Service Endpoint Alias</a></li>
              %endif%
          </UL>
        </TD>
      </TR>
