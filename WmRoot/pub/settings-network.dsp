            ...
            <TR>
                    ...
                    <script>writeTD("rowdata");</script>
                        <a class="imagelink" onClick="return confirmDelete('%value proxyAlias%');">
                            <img src="icons/delete.png" alt="Delete alias : %value proxyAlias%" border=0>
                        </a>
                    </TD>
            %endscope%
            </TR>
