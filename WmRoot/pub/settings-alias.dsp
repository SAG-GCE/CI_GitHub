...
<TR>
    <script>writeTD("rowdata-l");</script>
        <a
       href="settings-alias-addedit.dsp?action=edit&alias=%value -urlencode alias%&urlPath=%value -urlencode urlPath%&portList=%value -urlencode portList%&association=%value -urlencode association%&package=%value -urlencode package%&isDev=%switch association%%case '0'%false%case '1'%false%case%true%endif%"
