...
<head>
  ...
  <body onLoad="setNavigation('settings-cache-manager-view.dsp', '/WmRoot/doc/OnlineHelp/wwhelp.htm?context=is_help&topic=IS_Settings_CacheManager_Details');">
    <table width="100%">
        <tr>
            <td class="breadcrumb" colspan="2"> Settings &gt; Caching &gt; %value cacheManagerName%</td>
        </tr>
            ...
            <td colspan="2">
                <ul class="listitems">
                    ...
                    %ifvar isInternal equals('false')%
                        <li class="listitem"><a href="javascript:document.htmlform_cache_add.submit();" onClick="return populateCacheForm(document.htmlform_cache_add,'%value cacheManagerName%','','add');">Add Cache</a></li>
                        <li class="listitem"><a href="javascript:document.htmlform_manager_edit.submit();" onClick="return populateCacheManagerForm(document.htmlform_manager_edit,'%value cacheManagerName%','edit');">Edit Cache Manager Configuration</a></li>
                    %endif%
                </ul>
            </td>
        </tr>
