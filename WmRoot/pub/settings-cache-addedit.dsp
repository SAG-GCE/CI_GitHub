      ...
      <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <ul class="listitems">
                    <li class="listitem">
                        <a href="settings-cache-manager-view.dsp?managerType=%value -urlencode managerType%&cacheManagerName=%value -urlencode cacheManagerName%">Return to&nbsp;%value cacheManagerName%</a></li>
                    %ifvar configMismatch%
                        <li class="listitem">
                            <a href="settings-cache-diff.dsp?cacheManagerName=%value -urlencode cacheManagerName%&cacheName=%value -urlencode cacheName%">Synchronize Cache Settings from Terracotta Server Array</a></li>
                    %endif%
                </ul>
            </td>
        </tr>
                        ...
                        <td valign="top" width="50%">   
                            <table class="tableView" width="100%" padding="2em" margin="2em">
                                ...
                                <tr>
                                    ...
                                    %endif% 
                                    %ifvar operation equals('edit')%
                                        <input type="checkbox" name="overflowToOffHeap" id="overflowToOffHeap" onclick="enableDisableMaximumOffHeapField();" %ifvar overflowToOffHeap equals('true')%checked%endif% %ifvar licenseDetails/isBigMemoryLicensed equals('false')%disabled="disabled"%else%%ifvar isInternal equals('true')%%ifvar terracottaConfiguration/clustered equals('true')%disabled="disabled"%endif%%endif%%endif%>
                                    %endif% 
                                    </td>
                                </tr>
