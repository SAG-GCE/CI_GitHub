    ...
    <TABLE width="100%">
      ...
      <TR>
        ...
        <input type="hidden" name="passwordChanged" value="false">
            ...
            <tr>
        <td valign=top>
        <table class="%ifvar ../mode equals('view')%tableView%else%tableView%endif%" width="100%">
          ...
          <tr>
            ...
            <td class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              ...
              %else%
                ...
                %ifvar authorize equals('no')%
                    <a class="submodal" style="display:inline" id=subUserSearchlink href="subUserLookup.dsp"><img border=0 align="bottom" src="icons/magnifyglass.png"/></a>  
                    %else%
                        <a class="submodal" style="display:none" id=subUserSearchlink href="subUserLookup.dsp"><img border=0 align="bottom" src="icons/magnifyglass.png"/></a>  
                    %endif%
