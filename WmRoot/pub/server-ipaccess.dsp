    ...
    <TR>
      ...
      %loop deny%
          <TR>
            ...
            <A class="imagelink" HREF="server-ipaccess.dsp?action=delete&deny=%value%" ONCLICK="return confirmIt('delete', 'deny', '%value%');"><IMG SRC="icons/delete.png" alt="Delete this host" border="0"></A></TD>
          </TR>
          %endloop%
      %case 'exclude'%
          <TR>
          ...
          <TR>
            ...
            %value%</TD>
            <script>writeTD('rowdata');swapRows();</script>
            <A class="imagelink" HREF="server-ipaccess.dsp" ONCLICK="return confirmIt('delete', 'allow', '%value%');"><IMG SRC="icons/delete.png" alt="Delete this host" border="0"></A></TD>
          </TR>
          %endloop%
      %endswitch%
      </TD>
