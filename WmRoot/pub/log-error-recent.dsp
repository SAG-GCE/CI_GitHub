                  ...
                  <TR>
                     ...
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
                         <TABLE style="padding: 0; margin: 0">
                           %loop ServiceStack%
                            <TR><TD nowrap style="border: none">%value ServiceStack%</TD></TR>
                           %endloop%
                         </TABLE>
                     </TD>
                     <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
                         <TABLE style="padding: 0; margin: 0">
                           %loop ErrorMessage%
                            <TR><TD nowrap style="border: none">%value ErrorMessage%</TD></TR>
                           %endloop%
                         </TABLE>
                     </TD>
                     %ifvar ../expandchecked equals('CHECKED')%
                       <SCRIPT>writeTDnowrap("row-l");</SCRIPT>
                         <TABLE style="padding: 0; margin: 0">
                           %loop ErrStackTrace%
                            <TR><TD nowrap style="border: none">%value ErrStackTrace%</TD></TR>
                           %endloop%
                         </TABLE>
                     %else%
