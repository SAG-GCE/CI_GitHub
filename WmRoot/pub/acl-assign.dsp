     ...
     <TABLE width=100%>
      ...
      %value interface% &gt;
         ...
         <TR>
          <TD colspan=2>
            <UL>
              <!-- <li class="listitem"><a href="service-list.dsp?interface=%value interface%">Return to browsing %value interface%</a></li> -->
              %ifvar parent -notempty%
                <li class="listitem"><a href="service-list.dsp?interface=%value parent%">Return to browsing %value parent%</a></li>
              %else%
                <li class="listitem"><a href="service-list.dsp?interface=%value interface%">Return to browsing %value interface%</a></li>
              %endif%
            </UL>
