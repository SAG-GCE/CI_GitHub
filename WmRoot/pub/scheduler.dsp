    ...
    <tr>
      <td>
        <table class="tableView" width=100%>
          ...
          %else%
           %ifvar error%
           <tr><td class="evenrow-l" colspan=11>error: %value error%</td></tr>
           %else%
            ...
            %else%
              ...
              %else%
                    ...
                    %else%
                        <script>writeTD("rowdata-l");</script>
                    %endif%
                    <a href="javascript:redirectPage('suspend','%value oid%')" onclick="return confirm('Are you sure you want to suspend task?');"><img src="images/green_check.png" border=0>%ifvar execState equals('running')%Running%else%Active%endif%</a></td>
              %endif%
            %endif%

            <script>writeTD("rowdata");</script>
                 <a class="imagelink" href="javascript:redirectPage('cancel','%value oid%')" onclick="return confirm('Are you sure you want to remove this task?');"><img src="icons/delete.png" border=0></a></td>
          </tr>
