    ...
    <tr>
      <td colspan="2">
        ...
        <!--    %ifvar hasTriggers equals('true')%
            ...
            %else%
              <li class="listitem"><a href="settings-jms.dsp?action=delete&aliasName=%value aliasName%" onClick="javascript:return confirm('Are you sure you want to delete Connection Alias %value connectionAliasName%?')">
