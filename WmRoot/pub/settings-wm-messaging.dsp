            ...
            <tr>
              ...
              %else%
                ...
                %ifvar connected equals('false')%
                  ...
                  %else%
                    %ifvar lastError%
                      <a href="settings-wm-messaging.dsp?action=changeState&aliasName=%value aliasName encode(url)%&setEnabled=false"><img style="width: 13px; height: 13px;" alt="enabled" border="0" src="images/yellow_check.png">Yes</a>&nbsp;[Not&nbsp;Connected]
                    %else%
                      <a href="settings-wm-messaging.dsp?action=changeState&aliasName=%value aliasName encode(url)%&setEnabled=false"><img style="width: 13px; height: 13px;" alt="active" border="0" src="images/yellow_check.png">Yes</a>&nbsp;[Not&nbsp;Connected]
                    %endif%
                  %endif%
                %else%
